...
import 'package:employee_app/utils/network_manager.dart';

class API {
  NetworkManager _networkManager = new NetworkManager();

  static final String apiUrl = "http://www.mocky.io/v2/5d565297300000680030a986";
  ...
  Future<EmployeeList?> getListFromServer() async {
    try {
      ...
      ParsedResponse result = await _networkManager.post(apiUrl, headers: headers, params: {});
